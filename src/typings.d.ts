 ...
 * execution of services across multiple processes and/or compute
 * nodes.
 */
 ...
 */
   ...
   */
  export type Subscriber = (blabbermouth: IBlabber, event: Event)
    => Promise<Object> | void;
  ...
  /**
   * A recipt for the delivery of a message to a service.
   */
  type Reciept = {
    uuid: string,
    topicId: string,
